...
class ContentProtection extends StatefulWidget {
  const ContentProtection({super.key});

  @override
  State<ContentProtection> createState() => _ContentProtectionState();
}

class _ContentProtectionState extends State<ContentProtection> with DwmContentProtectionListener {
